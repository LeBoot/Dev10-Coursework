...
public class BullCowDaoImplDBTest {
    ...
    public void testAddRoundANDGetAllRoundsByGameID() {
        ...
        List<BullCowRoundObject> listGame1 = dao.getAllRoundsByGameID(game1.getGameID());
        List<BullCowRoundObject> listGame2 = dao.getAllRoundsByGameID(game2.getGameID());
    ...
    public void testDeleteRoundByGameId() {
        ...
        BullCowRoundObject round1 = new BullCowRoundObject();
        round1.setGameID(newGame.getGameID());
        round1.setGuess("1234");
        round1.setRoundResults("e:0:p:0");
        round1.setTimeOfGuess(LocalDateTime.now().withNano(0));
        round1 = dao.addRound(round1);

        //retrieve all round for that game
        List<BullCowRoundObject> allRounds = dao.getAllRoundsByGameID(newGame.getGameID());
