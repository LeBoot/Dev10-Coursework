...
public class InABucket {
    public static void  main(String[] args) {
        ...
        //But declaring them just sets up the space for data to use the variable,
        //you have to put data IN it first!
        walrus = "Sir Leroy Jenkins III";
        piesEaten = 42.1;
        
        System.out.println("Meet my pet Walrus, " + walrus);
        System.out.print("He was a bit hugnry today and ate this many pies: ");
