...
public class ContactController {
    ...
    public ResponseEntity<HttpStatus> addNewMessage(@RequestBody RBNewMessage rbNewMessage) {
    ...
    //Edit a message, coming from TSPadmin.html --------------------------------
    @PostMapping("/edit-message")
    public ResponseEntity<HttpStatus> editMessage(@RequestBody RBEditMessage message) {
        //validate message in service layer
        boolean isRequestValid = contactService.validateEditMessageRB(message);
