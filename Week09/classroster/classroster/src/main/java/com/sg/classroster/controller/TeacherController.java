...
public class TeacherController {
   ...
   //This is to hold the errors that arise from validation
...
//        teacherDao.addTeacher(teacher);
        ...
        Validator myValidate = Validation.buildDefaultValidatorFactory().getValidator();
        violations = myValidate.validate(teacher);
