...
import com.bl.HelloSecurity.dao.RoleDao;
...
//        List<RoleObject> roleList = roles.getAllRoles();
//        
...
//    }
    ...
    public String editUserAction(String[] roleIdList, Boolean enabled, Integer id) {
        ...
        Set<RoleObject> roleList = new HashSet<>();
        for(String roleId : roleIdList) {
            RoleObject role = roles.getRoleById(Integer.parseInt(roleId));
            roleList.add(role);
        }
