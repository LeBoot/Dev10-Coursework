 ...
 * @author Boone
 */
@Controller //@Controller indicates that this file should be loaded as a bean by Spring,
    //because of this, Spring will look for other annotations, such as those for mapping
